<template>
  <v-card color="#202022" class="rounded-lg mt-n3 pb-1" flat>
    ...
    <v-card color="#242426" class="rounded-lg mx-2 pa-1 mt-n3 gradient flip" flat>
      <v-toolbar flat color="transparent">
        <v-toolbar-title class="grey--text capiton">Universal Card</v-toolbar-title>
        <v-spacer></v-spacer>
        <v-icon color="grey">fab fa-cc-mastercard</v-icon>
      </v-toolbar>
      <span class="grey--text mt-3 ml-4 caption">Balance</span>
      <h2 class="white--text ml-4">$4.554.54</h2>
      <v-card-text class="pt-0 mt-4">
        <span class="white--text font-weight-light">**** **** **** 3554</span>
      </v-card-text>
    </v-card>
    <v-toolbar color="transparent" flat class="my-n2">
    ...
    <v-list class="mt-n6" color="transparent" dense>
      <v-list-item v-for="chat in chats" :key="chat.title">
        ...
        <v-list-item-content>
          <v-list-item-title v-text="chat.title" class="white--text"></v-list-item-title>
  ...
  <v-card color="#242426" class="rounded-lg mx-2 pa-1 mt-n3 gradient flip" flat>
    ...
    <span class="grey--text mt-4 ml-4 caption">Get out about our new items</span><br>
    <span class="grey-text ml-4 caption">for community</span> 
    <v-card-text class="pt-0 mt-5">
      <v-btn color="#524eed" dark class="withoutuppercase mt-2">Trial from $199</v-btn>
    </v-card-text>
  </v-card>
